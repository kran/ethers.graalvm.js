(function (global) {
    ...
    function createGetUrl(options) {
        function getUrl(req, _signal) {
            ...
            const respBody = resp.bodyBytes();
            const body = (respBody == null) ? null : new Uint8Array(respBody);
            return {
                statusCode: resp.getStatus(),
                statusMessage: "*DUMMY STATUS MSG*",//resp.statusText,
                headers,
                body
            };
        }
    ...
    class JsonRpcApiProvider extends AbstractProvider {
        ...
        #scheduleDrain(payload) {
            ...
            try {
                ...
                if (this.destroyed) {
                    throw (makeError("provider destroyed; cancelled request", "UNSUPPORTED_OPERATION", { operation: payload.method }));
                }
